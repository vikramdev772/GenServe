...
import { Radio, Button, Dropdown, Modal, Slider } from "antd";
...
const Deploypod = () => {
  ...
  const marks = {
    ...
    80: "80",
    90: "90",
    100: { style: { color: "green" }, label: <strong>100</strong> },
  };
    ...
    <div>
      ...
      <div className="mt-4 p-4 bg-white rounded-lg shadow-md">
        <div className="flex flex-col md:flex-row md:items-center md:space-x-4">
          ...
          <div className="flex flex-row items-center justify-flex-start gap-2">
          <Dropdown
            menu={{ items }}
